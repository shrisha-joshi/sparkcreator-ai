...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-muted/30 via-background to-primary/5 border-t border-border">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Automating creator marketing with AI-powered discovery, content generation, 
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2024 CreatorFlow AI. All rights reserved.
          </p>
